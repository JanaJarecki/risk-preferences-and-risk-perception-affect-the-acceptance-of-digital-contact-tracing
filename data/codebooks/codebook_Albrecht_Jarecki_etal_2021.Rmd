...
meta_info <- list(
  ...
  citation = "Albrecht, R., Jarecki, J. B., Meier, D., & Rieskamp, J. (in press). Risk Preferences and Risk Perception Affect the Acceptance of Digital Contact Tracing. *journal*, *volume*(issue), page range. DOI",
  creator =list(
    "@type" = "Person", 
    givenName = "Rebecca", 
    familyName = "Albrecht",
