...
var_label(data$raw_know_death_total) <- "How many people in Switzerland have died from an infection with the coronavirus since the beginning of the corona crisis?"
...
var_label(data$know_age) <- ""
var_label(data$know_infected_all_ab) <- ""
var_label(data$know_death_total) <- ""
