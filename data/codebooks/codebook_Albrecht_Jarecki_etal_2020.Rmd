...
var_label(data$comprehension_self) <- "Which of the following statements are correct about the functionality of the SwissCovid app? - When I use the SwissCovid app, this helps me stay healthy."
...
val_labels(data$education) <- c("Compulsory school not completed" = 1,
                                ...
                                "Basic vocational training (federal certificate of proficiency EFZ, federal certificate of vocational education and training EBA, commercial college, certificate of apprenticeship)" = 3, 
                                ...
                                "University (FH/PH/UH Bachelor, Master, Doctorate)" = 6)
